    ...
    renderOptions() {
        ...
        return this.options.map(option => {
            ...
            return `
                <li 
                    role="option" 
                    class="px-4 py-2 cursor-pointer flex items-center justify-between ${isSelected ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400' : 'hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200'}"
